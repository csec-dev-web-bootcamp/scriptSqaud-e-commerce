    ...
    <div className="h-full  grid grid-cols-6 ">
      <div className="w-full m-8 mt-9 col-span-1">
        ...
        <Collapsible className="w-fit">
          <CollapsibleTrigger className="w-24  "><div className=" border-b-2   py-2 text-lg w-full ">Shoes</div></CollapsibleTrigger>
        ...
        <Collapsible>
          <CollapsibleTrigger  className="w-24"><div className="border-b-2  py-2 text-lg  ">Shirt</div></CollapsibleTrigger>
